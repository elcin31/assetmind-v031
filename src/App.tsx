...
import { readPortfolio, STORAGE_KEY, exportPortfolio, importPortfolio } from './storage/portfolio';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const storage = (event: StorageEvent) => { if (event.key === STORAGE_KEY || event.key === null) update(); };
    update();
