...
describe('remaining basis before and after split sales', () => {
  it('tracks only unsold acquisition basis', () => {
    ...
    expect(calculatePositions(rows).positions[0].costBasis).toBe(60);
  });
});
