...
describe('position realized pnl after multiple splits and sell', () => {
  it('stores realized pnl on remaining position', () => {
    ...
    expect(calculatePositions(rows).positions[0].realizedPnL).toBe(25);
  });
});
