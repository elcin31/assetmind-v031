...
describe('remaining WAC after multiple splits and sell', () => {
  it('keeps composed post-split WAC after a sale', () => {
    ...
    expect(calculatePositions(rows).positions[0].averageCost).toBe(20);
  });
});
