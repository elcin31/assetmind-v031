...
describe('split dividend summary neutrality', () => {
  it('leaves dividend total unchanged', () => {
    const event: CashEvent = { id: 'd', portfolio_id: 'p', kind: 'DIVIDEND', amount: 5, currency: 'USD', timestamp: '2026-01-01T00:00:00Z', created_at: '2026-01-01T00:00:00Z' };
    ...
    expect(result.dividends).toBe(5);
  });
});
