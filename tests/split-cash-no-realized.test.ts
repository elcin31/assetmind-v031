...
describe('split cash and pnl separation', () => {
  it('contains no pnl-derived cash event for split', () => {
    ...
    expect(buildCashLedger([split], [], '2026-01-02T00:00:00Z', 'USD').entries).toEqual([]);
  });
});
