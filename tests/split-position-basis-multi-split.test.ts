...
describe('basis through multiple split events', () => {
  it('keeps acquisition basis unchanged', () => {
    const rows: Transaction[] = [
      { id: 'a', portfolio_id: 'p', symbol: 'XYZ', type: 'BUY', quantity: 5, price: 40, currency: 'USD', timestamp: '2026-01-01T00:00:00Z', created_at: '2026-01-01T00:00:00Z' },
    ...
    expect(calculatePositions(rows).positions[0].costBasis).toBe(200);
  });
});
