...
describe('explicit split ratio authority', () => {
  it('uses the transaction ratio without any external corporate-action lookup', () => {
    const rows: Transaction[] = [
      { id: 'a', portfolio_id: 'p', symbol: 'XYZ', type: 'BUY', quantity: 2, price: 30, currency: 'USD', timestamp: '2026-01-01T00:00:00Z', created_at: '2026-01-01T00:00:00Z' },
