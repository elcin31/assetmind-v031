...
describe('infinite split numerator', () => {
  it('does not mutate inventory when malformed local data reaches pure math', () => {
    const rows: Transaction[] = [
      ...
      { id: 'b', portfolio_id: 'p', symbol: 'XYZ', type: 'SPLIT', split_numerator: Number.POSITIVE_INFINITY, split_denominator: 1, currency: 'USD', timestamp: '2026-01-02T00:00:00Z', created_at: '2026-01-02T00:00:00Z' },
    ];
