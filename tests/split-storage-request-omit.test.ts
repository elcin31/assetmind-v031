...
describe('split request id domain shape', () => {
  it('omits client_request_id when database value is null', () => {
    ...
    expect(Object.prototype.hasOwnProperty.call(tx, 'client_request_id')).toBe(false);
  });
});
