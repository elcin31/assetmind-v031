...
describe('split recorded timestamp round trip', () => {
  it('preserves created_at through recorded_at', () => {
    const tx: SplitTransaction = { id: 's', portfolio_id: 'p', symbol: 'XYZ', type: 'SPLIT', split_numerator: 2, split_denominator: 1, currency: 'USD', timestamp: '2026-01-01T00:00:00Z', created_at: '2026-01-01T00:00:05Z' };
    ...
    expect(restored.created_at).toBe(tx.created_at);
  });
});
