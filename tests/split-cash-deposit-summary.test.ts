...
describe('split cash summary neutrality', () => {
  it('does not alter deposit totals', () => {
    const event: CashEvent = { id: 'd', portfolio_id: 'p', kind: 'DEPOSIT', amount: 250, currency: 'USD', timestamp: '2026-01-01T00:00:00Z', created_at: '2026-01-01T00:00:00Z' };
    ...
    expect(result.deposits).toBe(250);
