...
describe('split id round trip', () => {
  it('preserves transaction identity', () => {
    const tx: SplitTransaction = { id: 'split-id', portfolio_id: 'p', symbol: 'XYZ', type: 'SPLIT', split_numerator: 2, split_denominator: 1, currency: 'USD', timestamp: '2026-01-01T00:00:00Z', created_at: '2026-01-01T00:00:00Z' };
    ...
    expect(restored.id).toBe('split-id');
  });
});
