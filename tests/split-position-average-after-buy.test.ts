...
describe('WAC after split and later buy', () => {
  it('recomputes weighted average from preserved basis plus later purchase', () => {
    ...
    expect(calculatePositions(rows).positions[0].averageCost).toBeCloseTo(53.333333, 5);
  });
});
